...
public class InventarioFichaDAO implements ICrud {
    ...
    public String actualizar(Object id, Object registro) {
        String mensaje = null;
        try {
            int respuesta = InventarioFichaJSON.updateJSON((int) id, (InventarioFichaDTO) registro);
            mensaje = String.valueOf(respuesta);
    ...
    public String eliminar(Object id) {
        String mensaje = null;
        try {
            int respuesta = InventarioFichaJSON.deleteJSON((int) id);
            mensaje = String.valueOf(respuesta);
    ...
    public InventarioFichaDTO consultarPorId(int id) {
        try {
    ...
    public String actualizarSaldo(int id, int nuevoSaldo, String nombreBoveda) {
        String mensaje = null;
        try {
    ...
    public int obtenerSaldoActual(int id) {
        try {
    ...
    public String procesarMovimiento(int idInventario, int cantidad, String tipoMov) {
        try {
