...
public class TransaccionDAO implements ICrud {
    ...
    public String actualizar(Object id, Object registro) {
        String mensaje = null;
        try {
            int respuesta = TransaccionJSON.updateJSON((String) id, (TransaccionDTO) registro);
            mensaje = String.valueOf(respuesta);
    ...
    public String eliminar(Object id) {
        String mensaje = null;
        try {
            int respuesta = TransaccionJSON.deleteJSON((String) id);
            mensaje = String.valueOf(respuesta);
    ...
    public TransaccionDTO consultarPorId(String id) {
        try {
    ...
    public ArrayList<TransaccionDTO> filtrarPorCliente(String idCliente) {
        if (listaTransacciones == null) {
            consultar();
        }
        ArrayList<TransaccionDTO> filtradas = new ArrayList<>();
        if (listaTransacciones != null) {
            for (TransaccionDTO transaccion : listaTransacciones) {
                if (transaccion.getIdCliente() != null && transaccion.getIdCliente().equals(idCliente)) {
                    filtradas.add(transaccion);
                }
            }
        }
    ...
    public ArrayList<TransaccionDTO> filtrarPorEmpleado(String idEmpleado) {
        if (listaTransacciones == null) {
            consultar();
        }
        ArrayList<TransaccionDTO> filtradas = new ArrayList<>();
        if (listaTransacciones != null) {
            for (TransaccionDTO transaccion : listaTransacciones) {
                if (transaccion.getIdEmpleado() != null && transaccion.getIdEmpleado().equals(idEmpleado)) {
                    filtradas.add(transaccion);
                }
            }
        }
