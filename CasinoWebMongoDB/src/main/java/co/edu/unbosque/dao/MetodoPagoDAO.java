...
public class MetodoPagoDAO implements ICrud {
    ...
    public String actualizar(Object id, Object registro) {
        try {
            int respuesta = MetodoPagoJSON.updateJSON((String) id, (MetodoPagoDTO) registro);
            return String.valueOf(respuesta);
        } catch (IOException e) {
            e.printStackTrace();
            return "500";
    ...
    public String eliminar(Object id) {
        try {
            int respuesta = MetodoPagoJSON.deleteJSON((String) id);
            return String.valueOf(respuesta);
        } catch (IOException e) {
            e.printStackTrace();
            return "500";
    ...
    // ✅ Consultar por ID
    public MetodoPagoDTO consultarPorId(String id) {
        try {
