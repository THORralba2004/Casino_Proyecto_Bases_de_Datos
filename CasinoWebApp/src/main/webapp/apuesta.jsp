...
<head>
    ...
    <script>
        ...
        function calcularGananciaPerdida() {
            ...
            if (resultado === "GANADO") {
                gananciaPerdida = monto * 2; // Ejemplo: duplica la apuesta
            } else if (resultado === "PERDIDO") {
                gananciaPerdida = -monto; // Pierde lo apostado
            } else if (resultado === "EMPATE") {
                gananciaPerdida = 0; // Recupera lo apostado
            }
...
if (accion != null) {
    ...
    if (accion.equals("agregar")) {
        try {
            ...
            a.setIdCliente(Integer.parseInt(request.getParameter("idCliente")));
            a.setIdEvento(Integer.parseInt(request.getParameter("idEvento")));
            a.setIdEmpleado(Integer.parseInt(request.getParameter("idEmpleado")));
