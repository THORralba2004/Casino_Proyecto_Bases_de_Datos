...
public class TipoJuegoDAO implements ICrud {
    ...
    public TipoJuegoDTO obtenerPorId(int id) {
    ...
    public String actualizar(Object id, Object registro) {
        String mensaje = null;
        try {
            int respuesta = TipoJuegoJSON.updateJSON((int) id, (TipoJuegoDTO) registro);
            mensaje = String.valueOf(respuesta);
    ...
    public String eliminar(Object id) {
        String mensaje = null;
        try {
            int respuesta = TipoJuegoJSON.deleteJSON((int) id);
            mensaje = String.valueOf(respuesta);
