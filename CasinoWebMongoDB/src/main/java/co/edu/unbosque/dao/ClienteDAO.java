...
public class ClienteDAO implements ICrud {
    ...
    public String actualizar(Object id, Object registro) {
        String mensaje = null;
        try {
            int respuesta = ClienteJSON.updateJSON((String) id, (ClienteDTO) registro);
            mensaje = String.valueOf(respuesta);
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public String eliminar(Object id) {
        String mensaje = null;
        try {
            int respuesta = ClienteJSON.deleteJSON((String) id);
            mensaje = String.valueOf(respuesta);
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public ClienteDTO consultarPorId(String id) {
        try {
