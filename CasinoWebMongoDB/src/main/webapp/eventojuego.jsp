    ...
    <main>
        <section class="formulario">
            ...
            <form method="post" action="eventojuego.jsp">
                <input type="text" name="idEvento" placeholder="ID (solo si va a actualizar)">
            ...
            <%
                ...
                if (accion != null) {
                    ...
                    if (accion.equals("agregar")) {
                        String idTipoJuego = request.getParameter("idTipoJuego");
                ...
                <tbody>
                    ...
                    %>
                        <tr>
                            ...
                            <td><%= e.getEstado() %></td>
                            <td class="acciones">
                                <form method="post" action="eventojuego.jsp" style="display:inline;">
