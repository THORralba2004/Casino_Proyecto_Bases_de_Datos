...
if (accion != null) {
    try {
        if (accion.equals("agregar")) {
            ...
            t.setIdEmpleado(Integer.parseInt(request.getParameter("idEmpleado")));
            t.setIdMetodo(Integer.parseInt(request.getParameter("idMetodo")));
            t.setIdCliente(Integer.parseInt(request.getParameter("idCliente")));
            ...
            int id = Integer.parseInt(request.getParameter("idTransaccion"));
            TransaccionDTO t = new TransaccionDTO();
            t.setIdEmpleado(Integer.parseInt(request.getParameter("idEmpleado")));
            t.setIdMetodo(Integer.parseInt(request.getParameter("idMetodo")));
            t.setIdCliente(Integer.parseInt(request.getParameter("idCliente")));
