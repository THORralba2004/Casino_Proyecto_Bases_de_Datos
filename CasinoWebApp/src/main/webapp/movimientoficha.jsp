...
<head>
    ...
    <script>
        ...
        function cargarMovimiento(id, idInventario, idEmpleado, cantidad, tipoMov, observacion) {
            ...
            // Actualizar información de saldo
            actualizarInfoSaldo();
        }
        ...
        function actualizarInfoSaldo() {
            ...
            if (idInventario) {
                // En una implementación real, harías una llamada AJAX para obtener el saldo actual
                // Por ahora simulamos con un valor
                saldoActual = 1000; // Esto debería venir de una consulta real
...
if (accion != null) {
    ...
    if (accion.equals("agregar")) {
        try {
            ...
            movimiento.setIdInventario(Integer.parseInt(request.getParameter("idInventario")));
            movimiento.setIdEmpleado(Integer.parseInt(request.getParameter("idEmpleado")));
