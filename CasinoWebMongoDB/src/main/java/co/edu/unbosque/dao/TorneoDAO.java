...
public class TorneoDAO implements ICrud {
    ...
    public String actualizar(Object id, Object registro) {
        String mensaje = null;
        try {
            int respuesta = TorneoJSON.updateJSON((String) id, (TorneoDTO) registro);
            mensaje = String.valueOf(respuesta);
    ...
    public String eliminar(Object id) {
        String mensaje = null;
        try {
            int respuesta = TorneoJSON.deleteJSON((String) id);
            mensaje = String.valueOf(respuesta);
    ...
    public TorneoDTO consultarPorId(String id) {
        try {
